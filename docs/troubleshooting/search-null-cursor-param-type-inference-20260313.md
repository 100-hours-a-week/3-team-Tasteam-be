...
`cursor == null` 시 `NativeSearchExecutorSupport`의 네이티브 실행 루틴에서 아래 파라미터가 모두 null로 바인딩됐다.
...
`native strategy executor` SQL 텍스트(총 5건) 전부:

| SQL 텍스트 | 사용 전략 |
|---|---|
| `FtsMvRankedExecutor#buildSql` | `FTS_MV_RANKED` (기본값) |
| `HybridSplitExecutor#buildSql` | `HYBRID_SPLIT_CANDIDATES` |
| `GeoFirstHybridExecutor#buildSql` | `GEO_FIRST_HYBRID` |
| `ReadModelTwoStepExecutor#buildSql` | `READ_MODEL_TWO_STEP` |
| `MvSinglePassExecutor#buildSql` | `MV_SINGLE_PASS` |
...
**수정 파일**:
- `app-api/src/main/java/com/tasteam/domain/search/repository/executor/NativeSearchExecutorSupport.java`
- `app-api/src/main/java/com/tasteam/domain/search/repository/executor/nativesql/FtsMvRankedExecutor.java`
- `app-api/src/main/java/com/tasteam/domain/search/repository/executor/nativesql/HybridSplitExecutor.java`
- `app-api/src/main/java/com/tasteam/domain/search/repository/executor/nativesql/GeoFirstHybridExecutor.java`
- `app-api/src/main/java/com/tasteam/domain/search/repository/executor/nativesql/ReadModelTwoStepExecutor.java`
- `app-api/src/main/java/com/tasteam/domain/search/repository/executor/nativesql/MvSinglePassExecutor.java`
