...
graph BT
    ...
    classDef ext fill:#6B7280,stroke:#4B5563,color:#fff,rx:6

    APP["module-app:*\napi · admin · batch"]:::app
    INTERNAL["module-internal:*\nweb · security · observability"]:::internal
    INFRA["module-infra:*\npersistence · redis · messaging\nstorage · notification · geocode\nai · webhook · analytics"]:::infra
    DOMAIN["module-domain:core"]:::domain
    COMMON["module-common:support"]:::common
    EXT["표준 라이브러리\nSpring-web · Jackson · Jakarta Validation"]:::ext
