...
public enum RecommendationErrorCode implements ErrorCode {
	...
	RECOMMENDATION_RESULT_IO_ERROR(HttpStatus.SERVICE_UNAVAILABLE, "추천 결과 파일 접근 중 일시적 오류가 발생했습니다."),
	RECOMMENDATION_RESULT_VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "추천 결과 데이터 검증에 실패했습니다."),
	RECOMMENDATION_RESULT_POLLING_TIMEOUT(HttpStatus.REQUEST_TIMEOUT, "추천 결과 파일 대기 시간이 초과되었습니다.");
