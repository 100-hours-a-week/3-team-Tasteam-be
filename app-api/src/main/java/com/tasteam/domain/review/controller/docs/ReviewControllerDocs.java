...
public interface ReviewControllerDocs {
	...
	SuccessResponse<List<ReviewKeywordItemResponse>> getReviewKeywords(
		@Parameter(description = "키워드 타입 필터", schema = @Schema(implementation = KeywordType.class)) @RequestParam(required = false)
		KeywordType type);
	...
	SuccessResponse<ReviewDetailResponse> getReview(
		@Parameter(description = "리뷰 ID", example = "2001") @PathVariable @Positive
		Long reviewId);
