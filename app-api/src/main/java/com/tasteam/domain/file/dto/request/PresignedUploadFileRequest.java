...
public record PresignedUploadFileRequest(
	...
	String fileName,
	@Schema(description = "MIME 타입", example = "image/jpeg") @NotBlank(message = "contentType은 필수입니다") @Pattern(regexp = "^(image/jpeg|image/jpg|image/png|image/webp)$", message = "contentType은 image/jpeg(image/jpg), image/png, image/webp만 허용됩니다")
	String contentType,
