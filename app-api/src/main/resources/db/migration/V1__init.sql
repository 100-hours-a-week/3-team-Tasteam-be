...
alter sequence chat_message_file_id_seq owner to tasteam;
alter sequence chat_message_id_seq owner to tasteam;
alter sequence chat_room_id_seq owner to tasteam;
alter sequence chat_room_member_id_seq owner to tasteam;

alter sequence domain_image_seq owner to tasteam;
alter sequence group_auth_code_seq owner to tasteam;
alter sequence group_member_seq owner to tasteam;
alter sequence group_seq owner to tasteam;
alter sequence image_seq owner to tasteam;
alter sequence member_oauth_account_seq owner to tasteam;
alter sequence member_seq owner to tasteam;
alter sequence refresh_token_seq owner to tasteam;
alter sequence subgroup_member_seq owner to tasteam;
alter sequence subgroup_seq owner to tasteam;

alter sequence ai_restaurant_comparison_id_seq owner to tasteam;
alter sequence ai_restaurant_recommendation_id_seq owner to tasteam;
alter sequence ai_restaurant_review_analysis_id_seq owner to tasteam;

alter sequence announcement_id_seq owner to tasteam;
alter sequence food_category_id_seq owner to tasteam;
alter sequence image_optimization_job_id_seq owner to tasteam;
alter sequence keyword_id_seq owner to tasteam;
alter sequence member_favorite_restaurant_id_seq owner to tasteam;
alter sequence member_notification_preference_id_seq owner to tasteam;
alter sequence member_search_history_id_seq owner to tasteam;
alter sequence menu_id_seq owner to tasteam;
alter sequence menu_category_id_seq owner to tasteam;
alter sequence message_queue_trace_log_id_seq owner to tasteam;
alter sequence notification_id_seq owner to tasteam;
alter sequence promotion_id_seq owner to tasteam;
alter sequence promotion_asset_id_seq owner to tasteam;
alter sequence promotion_display_id_seq owner to tasteam;
alter sequence push_notification_target_id_seq owner to tasteam;
alter sequence restaurant_address_id_seq owner to tasteam;
alter sequence restaurant_food_category_id_seq owner to tasteam;
alter sequence restaurant_schedule_override_id_seq owner to tasteam;
alter sequence restaurant_weekly_schedule_id_seq owner to tasteam;
alter sequence review_id_seq owner to tasteam;
alter sequence review_keyword_id_seq owner to tasteam;
alter sequence subgroup_favorite_restaurant_id_seq owner to tasteam;

alter sequence ai_restaurant_comparison_id_seq owned by ai_restaurant_comparison.id;
alter sequence ai_restaurant_recommendation_id_seq owned by ai_restaurant_recommendation.id;
alter sequence ai_restaurant_review_analysis_id_seq owned by ai_restaurant_review_analysis.id;

alter sequence announcement_id_seq owned by announcement.id;
alter sequence food_category_id_seq owned by food_category.id;
alter sequence image_optimization_job_id_seq owned by image_optimization_job.id;
alter sequence keyword_id_seq owned by keyword.id;
alter sequence member_favorite_restaurant_id_seq owned by member_favorite_restaurant.id;
alter sequence member_notification_preference_id_seq owned by member_notification_preference.id;
alter sequence member_search_history_id_seq owned by member_search_history.id;
alter sequence menu_id_seq owned by menu.id;
alter sequence menu_category_id_seq owned by menu_category.id;
alter sequence message_queue_trace_log_id_seq owned by message_queue_trace_log.id;
alter sequence notification_id_seq owned by notification.id;
alter sequence promotion_id_seq owned by promotion.id;
alter sequence promotion_asset_id_seq owned by promotion_asset.id;
alter sequence promotion_display_id_seq owned by promotion_display.id;
alter sequence push_notification_target_id_seq owned by push_notification_target.id;
alter sequence restaurant_address_id_seq owned by restaurant_address.id;
alter sequence restaurant_food_category_id_seq owned by restaurant_food_category.id;
alter sequence restaurant_schedule_override_id_seq owned by restaurant_schedule_override.id;
alter sequence restaurant_weekly_schedule_id_seq owned by restaurant_weekly_schedule.id;
alter sequence review_id_seq owned by review.id;
alter sequence review_keyword_id_seq owned by review_keyword.id;
alter sequence subgroup_favorite_restaurant_id_seq owned by subgroup_favorite_restaurant.id;